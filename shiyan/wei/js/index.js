var timer = setTimeout(function(){
  ...
  window.location.href = "wonderful.html";
...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('|#countdown 3|0|生日快乐|魏朝旭|！！！|⌓‿⌓|祝|你||余生如花|我花开后|百花杀||余生似水|水利万物|而不争||余生如玉|一片冰心|在玉壶||余生似云|静观天下|尽婆娑||*⁂((✪⥎✪))⁂*|傲霜斗雪|ƪ(˘⌣˘)ʃ|水滴石穿|(ง •̀_•́)ง|冰清玉洁|٩(￥A￥)۶|云兴霞蔚|/(≧▽≦)/|#rectangle|');
    }
